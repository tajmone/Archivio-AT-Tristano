...
- [Contenuti del Progetto](#contenuti-del-progetto)
    - [Avventure Testuali](#avventure-testuali)
        ...
        - [Il Golem](#il-golem)
    - [Sistemi di Sviluppo IF](#sistemi-di-sviluppo-if)
        - [ADRIFT 4 Italian](#adrift-4-italian)
...
Vincitrice 1° Premio del _Concorso Avventure Testuali 2010_.
...
Non ho ancora avuto modo di archiviare copia de _Il Golem_ in questo progetto; nel frattempo questi sono i link di riferimento esterni:


- [ZenFactor.org][Golem » ZenFactor.org] — homepage ufficiale su [ZenFactor.org] (archiviata su Wayback Machine)
- [IFDB][Golem » IFDB] — pagina de _Il Golem_ sul sito [IFDB].
- [ADRIFT.co][Golem » ADRIFT] — pagina de _Il Golem_ sul sito ADRIFT.
- [IF Archive][Golem » IF Archive] — copia de _Il Golem_ su [IF Archive].

È possibile scaricare _Il Golem_ ai link sopra elencati, oppure tramite questo link diretto a IF Archive:

- [scarica _Il Golem_][Golem download] — link diretto (zippato, 6.3 Mb)
...
Per la realizzazione dell'avventura _[Il Golem]_ avevo tradotto la libreria di ADRIFT 4 in italiano, basandomi sulla traduzione italiana di ADRIFT 3 curata da [Roberto Grassi].

Non ho ancora avuto modo di recuperare e riordinare i vari file della libreria ADRIFT 4 Italian e pubblicarli in questo progetto. Non appena riuscirò a trovare il tempo per organizzarmi lo farò. Nel frattempo, dovrebbe essere possibile estrarli da _[Il Golem]_ (richiede la password, se vi serve contattatemi).
...
> __NOTA__ — Alan 3 è ancora in versione Beta.
...
[Il Golem]: #il-golem "Salta alla sezione “Il Golem” di questo documento"
...
[IF Archive]: http://www.ifarchive.org/ "Vai all’Interactive Fiction Archive"
...
[HL Alan]: https://gitlab.com/saalen/highlight/blob/master/langDefs/alan.lang

<!-- Profili Autori ---------------------------------------------------------->

[Emily Short]: https://en.wikipedia.org/wiki/Emily_Short "Vedi la pagina Wikipedia dedicata a Emily Short"
[Roberto Grassi]: http://ifwiki.org/index.php/Roberto_Grassi "Vedi il profilo di Roberto Grassi su IFWiki"


<!-- Il Golem ---------------------------------------------------------------->

[Golem download]: http://ifarchive.org/if-archive/games/adrift/italian/IlGolem.zip "Scarica 'Il Golem' dallo IF Archive (Zip 6.3 Mb)"
[Golem » ADRIFT]: http://www.adrift.co/game/1378 "Visita la pagina de “Il Golem” su ADRIFT"
[Golem » IF Archive]: http://www.ifarchive.org/indexes/if-archiveXgamesXadriftXitalian.html "Vedi copia archiviata de “Il Golem” nello IF Archive"
[Golem » IFDB]: http://ifdb.tads.org/viewgame?id=qiwcgyhs3k76s0fh "Visita la pagina de “Il Golem” su IFDB"
[Golem » ZenFactor.org]: https://web.archive.org/web/20170226192251/http://avventure-testuali.zenfactor.org/il_golem.htm "Visita la homepage de “Il Golem” su ZenFactor.org (archiviata su Wayback Machine)"
